...
<head>
    ...
    <meta name="google-site-verification" content="09CSqAKaZmeFf1mwkHn-gNbupyx2YNzrrn1SwAMV1lQ" />
    <meta charset="UTF-8">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="Images/carousel3.jpg" alt="Los Angeles" width="100%" height="500px;">
          </div>
          <div class="carousel-item">
            <img src="Images/carousel2.jpg" alt="Chicago" width="100%" height="500">
          </div>
          <div class="carousel-item">
            <img src="Images/carousel1.jpg" alt="New York" width="100%" height="500">
          </div>
        </div>
    ...
    <div class="m-auto main">
        <div class="row mt-4">
            ...
            <div class="col-lg-8 col-md-12">
                <h1 class="display-3">The Complete Responsive CMS Blog</h1>
                <h1 class="lead">The Complete blog by using php</h1>
                <?php echo ErrorMessage(); echo SuccessMessage(); ?>
                <div class="jumbotron text-light" style="background-image: url('Images/wood.jpg');">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card mb-3" style="min-height: 700px">
                                ...
                                <div class="card-body">
                                    ...
                                    <img class="mt-2" style="height: 300px; width: 100%; display: block;" src="Upload/<?= $Image;?>" alt="<?= $Image; ?>">
